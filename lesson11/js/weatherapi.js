...
if (page == "preston"){
  var apiURL = "https://api.openweathermap.org/data/2.5/weather?&id=5604473&units=imperial&APPID=dd66e694e0d52ba4a1b5e0c95a8a7857";
} else if (page == "sodaSprings") {
  var apiURL = "https://api.openweathermap.org/data/2.5/weather?&id=5607916&units=imperial&APPID=dd66e694e0d52ba4a1b5e0c95a8a7857";
} else {
  var apiURL = "https://api.openweathermap.org/data/2.5/weather?&lat=42&lon=111&units=imperial&APPID=dd66e694e0d52ba4a1b5e0c95a8a7857";
}
...
/******************************FORECAST FOR 5 DAYS******************************/
if (page == "preston") {
  var apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?&id=5604473&units=imperial&APPID=dd66e694e0d52ba4a1b5e0c95a8a7857";
} else if (page == "sodaSprings") {
  var apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?&id=5607916&units=imperial&APPID=dd66e694e0d52ba4a1b5e0c95a8a7857";
} else {
  var apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?&lat=42&lon=111&units=imperial&APPID=dd66e694e0d52ba4a1b5e0c95a8a7857";
}
